								...
								<li class="cart_item clearfix">
									...
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
									    ...
									    <div class="cart_item_name cart_info_col">
											<img src="{{asset($row->options->image)}}" style="height: 50px">
										</div>
...
var stripe = Stripe('pk_test_51HAUXuHDIbQEoMM1rQ5oyIIOpbrviCMXtdUqzagllLa8Sktp5Je0BhTXgolCV1eZEcdz3GZlHVIo7NlG5kAZrwtl00d6UkXQa9');
