		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li data-image="{{ asset($product->image_one) }}"><img src="{{ asset($product->image_one) }}" alt="" style="height: 100px; width: 100px;"></li>
						<li data-image="{{ asset($product->image_two) }}"><img src="{{ asset($product->image_two) }}" alt="" style="height: 100px; width: 100px;"></li>
						<li data-image="{{ asset($product->image_three) }}"><img src="{{ asset($product->image_three) }}" alt="" style="height: 100px; width: 100px;"></li>
					</ul>
				</div>
							...
							<form action="{{ url('cart/product/add/'.$product->id) }}" method="post">
								...
								<div class="clearfix" style="z-index: 1000;">
                                 ...
                                 <div class="product_price"> Price : {{ $product->selling_price }} Tk</div>
                                  ...
                                  @endif
                                  @if($product->discount_price != NULL)
                                  <div class="product_price">Price: {{ $product->discount_price }} Tk</div>
                                  @else
                                  @endif
