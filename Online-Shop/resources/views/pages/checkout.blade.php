	...
	<div class="cart_section">
		<div class="container">
						...
						<div class="cart_items">
							<ul class="cart_list">
								...
								<li class="cart_item clearfix">
									<div class="cart_item_image"><img src="{{asset( $row->options->image )}}" alt="" style="height: 120px; width: 120px;"></div>
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                       ...
                                       @endif
										...
										<div class="cart_item_quantity cart_info_col">
											...
											<input type="number" name="qty" value="{{ $row->qty }}" style="width: 100px;height: 30px">
			...
			<div class="order_total_content " style="padding: 14px;">
				...
				<li class="list-group-item">Coupon : ({{   Session::get('coupon')['name'] }}) <a href="{{ route('coupon.remove') }}" class="btn btn-danger btn-sm">x</a> 
				...
				@endif
				  ...
				  <li class="list-group-item">Vat :  <span style="float: right;"> 0 Tk</span></li>
				  @if(Session::has('coupon'))
				  <li class="list-group-item">Total:  <span style="float: right;">{{ Session::get('coupon')['balance']+ $charge }} Tk</span> </li>
				  @else
				  <li class="list-group-item">Total:  <span style="float: right;"> {{ Cart::Subtotal() + $charge }} Tk</span> </li>
				  @endif
			</ul>
	</div>
</div>
